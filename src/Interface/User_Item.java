 ...
 * @author
 */
public class User_Item extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_Item.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
