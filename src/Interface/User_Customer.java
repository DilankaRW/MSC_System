...
public class User_Customer extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            setExtendedState(User_Customer.ICONIFIED);
    ...
    private void jbtn_ADD_Customer_Savejbtn_ADD_Customer_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_ADD_Customer_Savejbtn_ADD_Customer_SaveActionPerformed
        if (!jlbl_Customer_ID.getText().isEmpty() && !jtxt_Customer_Name.getText().isEmpty() && !jtxt_Customer_Phone_number.getText().isEmpty() && !jtxt_Customer__Email.getText().isEmpty() && !jtxt_Customer_Address.getText().isEmpty()) {
            try {
